...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_main_dialog_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_main_dialog_t qt_meta_stringdata_main_dialog = {
    {
QT_MOC_LITERAL(0, 11), // "main_dialog"
QT_MOC_LITERAL(12, 22), // "on_enter_child_clicked"
QT_MOC_LITERAL(35, 0) // ""

    },
    "main_dialog\0on_enter_child_clicked\0"
};
...
void main_dialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<main_dialog *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->on_enter_child_clicked(); break;
        default: ;
        }
    }
    (void)_a;
...
const QMetaObject main_dialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_main_dialog.offsetsAndSize,
    qt_meta_data_main_dialog,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_main_dialog_t
, QtPrivate::TypeAndForceComplete<main_dialog, std::true_type>
